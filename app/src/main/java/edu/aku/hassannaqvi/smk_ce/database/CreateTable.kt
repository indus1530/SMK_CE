...
object CreateTable {
    ...
    const val SQL_CREATE_LHW = ("CREATE TABLE "
            ...
            + LHWContract.LHWTable.COLUMN_UID + " TEXT,"
            + LHWContract.LHWTable.COLUMN_UUID + " TEXT,"
            + LHWContract.LHWTable.COLUMN_SERIAL_NO + " TEXT,"
            + LHWContract.LHWTable.COLUMN_USERNAME + " TEXT,"
            + LHWContract.LHWTable.COLUMN_SYSDATE + " TEXT,"
            + LHWContract.LHWTable.COLUMN_STATUS + " TEXT,"
            + LHWContract.LHWTable.COLUMN_ENDINGDATETIME + " TEXT,"
            + LHWContract.LHWTable.COLUMN_DEVICEID + " TEXT,"
            + LHWContract.LHWTable.COLUMN_DEVICETAGID + " TEXT,"
            + LHWContract.LHWTable.COLUMN_SYNCED + " TEXT,"
            + LHWContract.LHWTable.COLUMN_SYNCED_DATE + " TEXT,"
            + LHWContract.LHWTable.COLUMN_APPVERSION + " TEXT,"
            + LHWContract.LHWTable.COLUMN_DISTRICT_CODE + " TEXT,"
            + LHWContract.LHWTable.COLUMN_DISTRICT_NAME + " TEXT,"
            + LHWContract.LHWTable.COLUMN_TEHSIL_CODE + " TEXT,"
