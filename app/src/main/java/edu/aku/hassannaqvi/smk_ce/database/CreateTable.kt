...
object CreateTable {
    ...
    const val SQL_CREATE_HHINFO = ("CREATE TABLE "
            ...
            + HHInfoContract.HHInfoTable.COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            + HHInfoContract.HHInfoTable.COLUMN_PROJECT_NAME + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_UID + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_UUID + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_SERIAL_NO + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_USERNAME + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_SYSDATE + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_STATUS + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_ENDINGDATETIME + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_DEVICEID + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_DEVICETAGID + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_SYNCED + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_SYNCED_DATE + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_APPVERSION + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_DISTRICT_CODE + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_DISTRICT_NAME + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_TEHSIL_CODE + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_TEHSIL_NAME + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_LHW_CODE + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_LHW_NAME + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_KHANDAN_NUMBER + " TEXT,"
            + HHInfoContract.HHInfoTable.COLUMN_SA + " TEXT"
            + " );")
