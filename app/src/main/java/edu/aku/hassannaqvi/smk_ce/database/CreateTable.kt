...
object CreateTable {
    ...
    const val SQL_CREATE_HHIDENTIFY = ("CREATE TABLE "
            ...
            + HHIdentifyContract.HHIdentifyTable.COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_PROJECT_NAME + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_UID + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_UUID + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_SERIAL_NO + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_USERNAME + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_SYSDATE + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_STATUS + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_ENDINGDATETIME + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_DEVICEID + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_DEVICETAGID + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_SYNCED + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_SYNCED_DATE + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_APPVERSION + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_DISTRICT_CODE + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_DISTRICT_NAME + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_TEHSIL_CODE + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_TEHSIL_NAME + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_LHW_CODE + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_LHW_NAME + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_KHANDAN_NUMBER + " TEXT,"
            + HHIdentifyContract.HHIdentifyTable.COLUMN_SA + " TEXT"
            + " );")
