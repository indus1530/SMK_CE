...
object CreateTable {
    ...
    const val SQL_CREATE_LHW = ("CREATE TABLE "
            + LHWHouseholdContract.LHWTable.TABLE_NAME + "("
            + LHWHouseholdContract.LHWTable.COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            + LHWHouseholdContract.LHWTable.COLUMN_PROJECT_NAME + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_UID + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_UUID + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_SERIAL_NO + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_USERNAME + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_SYSDATE + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_STATUS + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_ENDINGDATETIME + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_DEVICEID + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_DEVICETAGID + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_SYNCED + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_SYNCED_DATE + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_APPVERSION + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_DISTRICT_CODE + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_DISTRICT_NAME + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_TEHSIL_CODE + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_TEHSIL_NAME + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_LHW_CODE + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_LHW_NAME + " TEXT,"
            + LHWHouseholdContract.LHWTable.COLUMN_KHANDAN_NUMBER + " TEXT"
            + " );")
